...
export default async function EmployeeVerificationPage({
  ...
  return (
    <div className="min-h-screen bg-gray-100 sticky top-0 z-100 flex items-center justify-center p-2 font-sans text-black">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden border border-gray-200">
        ...
        <div className={`p-2 text-center text-white transition-colors duration-300 ${isActive ? "bg-emerald-600" : "bg-rose-600"}`}>
          <h1 className="font-bold uppercase tracking-wide flex items-center justify-center gap-2">
            <Image src="/logo.png" alt="Sachin Security Services logo" width={24} height={24} className="inline-block" />
        ...
        <div className="p-2 text-center">
          <h2 className="font-bold text-gray-900 uppercase tracking-tight">{employee.fullName}  {isActive ?"✅":"InActive" }</h2>
        ...
        <div className="border-t border-gray-100 px-6 py-4 space-y-4 bg-gray-50/50">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-bold text-rose-600">{employee.emergencyContactNumber|| "N/A"}</span>
          </div>
